var Se=(x,t)=>()=>(t||x((t={exports:{}}).exports,t),t.exports);var je=Se((_e,N)=>{(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const h of document.querySelectorAll('link[rel="modulepreload"]'))y(h);new MutationObserver(h=>{for(const g of h)if(g.type==="childList")for(const P of g.addedNodes)P.tagName==="LINK"&&P.rel==="modulepreload"&&y(P)}).observe(document,{childList:!0,subtree:!0});function d(h){const g={};return h.integrity&&(g.integrity=h.integrity),h.referrerPolicy&&(g.referrerPolicy=h.referrerPolicy),h.crossOrigin==="use-credentials"?g.credentials="include":h.crossOrigin==="anonymous"?g.credentials="omit":g.credentials="same-origin",g}function y(h){if(h.ep)return;h.ep=!0;const g=d(h);fetch(h.href,g)}})();const{searchParams:Le}=new URL(location.href),$=x=>Le.get(x),G=300,Ie=5,Re=10*1e3;class Te{constructor(){this.lastCommand=null;const t=$("channel")??"ManzDev",d=$("mode")??"bit";this.diploPollo=document.querySelector("diplo-pollo"),this.connect(t),d==="bit"&&this.enableBitMode(),d==="command"&&this.enableCommandMode()}connect(t){this.client=new tmi.Client({channels:[t]}),this.client.connect()}enableBitMode(){this.client.on("cheer",(t,d,y)=>{const h=d.bits??1,g=Math.floor(h/2);this.diploPollo.incNeck(g)})}enableCommandMode(){this.client.on("message",(t,d,y,h)=>{const g=y[0]==="!",P=new Date().getTime()-Re>this.lastCommand;if(!g||!P)return;if(y.split(" ").at(0).toLowerCase()==="!pollo"){const E=Number.parseInt(y.split(" ").at(1)??Ie);if(!(!isNaN(E)&&E>-G&&E<G))return;this.diploPollo.incNeck(E),this.lastCommand=new Date().getTime()}})}}var N={};(function x(t,d,y,h){var g=!!(t.Worker&&t.Blob&&t.Promise&&t.OffscreenCanvas&&t.OffscreenCanvasRenderingContext2D&&t.HTMLCanvasElement&&t.HTMLCanvasElement.prototype.transferControlToOffscreen&&t.URL&&t.URL.createObjectURL),P=typeof Path2D=="function"&&typeof DOMMatrix=="function";function T(){}function E(a){var e=d.exports.Promise,n=e!==void 0?e:t.Promise;return typeof n=="function"?new n(a):(a(T,T),null)}var M=function(){var a=Math.floor(16.666666666666668),e,n,r={},l=0;return typeof requestAnimationFrame=="function"&&typeof cancelAnimationFrame=="function"?(e=function(i){var s=Math.random();return r[s]=requestAnimationFrame(function o(c){l===c||l+a-1<c?(l=c,delete r[s],i()):r[s]=requestAnimationFrame(o)}),s},n=function(i){r[i]&&cancelAnimationFrame(r[i])}):(e=function(i){return setTimeout(i,a)},n=function(i){return clearTimeout(i)}),{frame:e,cancel:n}}(),ee=function(){var a,e,n={};function r(l){function i(s,o){l.postMessage({options:s||{},callback:o})}l.init=function(o){var c=o.transferControlToOffscreen();l.postMessage({canvas:c},[c])},l.fire=function(o,c,m){if(e)return i(o,null),e;var f=Math.random().toString(36).slice(2);return e=E(function(u){function b(w){w.data.callback===f&&(delete n[f],l.removeEventListener("message",b),e=null,m(),u())}l.addEventListener("message",b),i(o,f),n[f]=b.bind(null,{data:{callback:f}})}),e},l.reset=function(){l.postMessage({reset:!0});for(var o in n)n[o](),delete n[o]}}return function(){if(a)return a;if(!y&&g){var l=["var CONFETTI, SIZE = {}, module = {};","("+x.toString()+")(this, module, true, SIZE);","onmessage = function(msg) {","  if (msg.data.options) {","    CONFETTI(msg.data.options).then(function () {","      if (msg.data.callback) {","        postMessage({ callback: msg.data.callback });","      }","    });","  } else if (msg.data.reset) {","    CONFETTI && CONFETTI.reset();","  } else if (msg.data.resize) {","    SIZE.width = msg.data.resize.width;","    SIZE.height = msg.data.resize.height;","  } else if (msg.data.canvas) {","    SIZE.width = msg.data.canvas.width;","    SIZE.height = msg.data.canvas.height;","    CONFETTI = module.exports.create(msg.data.canvas);","  }","}"].join(`
`);try{a=new Worker(URL.createObjectURL(new Blob([l])))}catch(i){return typeof console!==void 0&&typeof console.warn=="function"&&console.warn("🎊 Could not load worker",i),null}r(a)}return a}}(),ae={particleCount:50,angle:90,spread:45,startVelocity:45,decay:.9,gravity:1,drift:0,ticks:200,x:.5,y:.5,shapes:["square","circle"],zIndex:100,colors:["#26ccff","#a25afd","#ff5e7e","#88ff5a","#fcff42","#ffa62d","#ff36ff"],disableForReducedMotion:!1,scalar:1};function te(a,e){return e?e(a):a}function oe(a){return a!=null}function v(a,e,n){return te(a&&oe(a[e])?a[e]:ae[e],n)}function ne(a){return a<0?0:Math.floor(a)}function re(a,e){return Math.floor(Math.random()*(e-a))+a}function z(a){return parseInt(a,16)}function ie(a){return a.map(le)}function le(a){var e=String(a).replace(/[^0-9a-f]/gi,"");return e.length<6&&(e=e[0]+e[0]+e[1]+e[1]+e[2]+e[2]),{r:z(e.substring(0,2)),g:z(e.substring(2,4)),b:z(e.substring(4,6))}}function se(a){var e=v(a,"origin",Object);return e.x=v(e,"x",Number),e.y=v(e,"y",Number),e}function ce(a){a.width=document.documentElement.clientWidth,a.height=document.documentElement.clientHeight}function de(a){var e=a.getBoundingClientRect();a.width=e.width,a.height=e.height}function pe(a){var e=document.createElement("canvas");return e.style.position="fixed",e.style.top="0px",e.style.left="0px",e.style.pointerEvents="none",e.style.zIndex=a,e}function he(a,e,n,r,l,i,s,o,c){a.save(),a.translate(e,n),a.rotate(i),a.scale(r,l),a.arc(0,0,1,s,o,c),a.restore()}function ue(a){var e=a.angle*(Math.PI/180),n=a.spread*(Math.PI/180);return{x:a.x,y:a.y,wobble:Math.random()*10,wobbleSpeed:Math.min(.11,Math.random()*.1+.05),velocity:a.startVelocity*.5+Math.random()*a.startVelocity,angle2D:-e+(.5*n-Math.random()*n),tiltAngle:(Math.random()*(.75-.25)+.25)*Math.PI,color:a.color,shape:a.shape,tick:0,totalTicks:a.ticks,decay:a.decay,drift:a.drift,random:Math.random()+2,tiltSin:0,tiltCos:0,wobbleX:0,wobbleY:0,gravity:a.gravity*3,ovalScalar:.6,scalar:a.scalar,flat:a.flat}}function me(a,e){e.x+=Math.cos(e.angle2D)*e.velocity+e.drift,e.y+=Math.sin(e.angle2D)*e.velocity+e.gravity,e.velocity*=e.decay,e.flat?(e.wobble=0,e.wobbleX=e.x+10*e.scalar,e.wobbleY=e.y+10*e.scalar,e.tiltSin=0,e.tiltCos=0,e.random=1):(e.wobble+=e.wobbleSpeed,e.wobbleX=e.x+10*e.scalar*Math.cos(e.wobble),e.wobbleY=e.y+10*e.scalar*Math.sin(e.wobble),e.tiltAngle+=.1,e.tiltSin=Math.sin(e.tiltAngle),e.tiltCos=Math.cos(e.tiltAngle),e.random=Math.random()+2);var n=e.tick++/e.totalTicks,r=e.x+e.random*e.tiltCos,l=e.y+e.random*e.tiltSin,i=e.wobbleX+e.random*e.tiltCos,s=e.wobbleY+e.random*e.tiltSin;if(a.fillStyle="rgba("+e.color.r+", "+e.color.g+", "+e.color.b+", "+(1-n)+")",a.beginPath(),P&&e.shape.type==="path"&&typeof e.shape.path=="string"&&Array.isArray(e.shape.matrix))a.fill(ge(e.shape.path,e.shape.matrix,e.x,e.y,Math.abs(i-r)*.1,Math.abs(s-l)*.1,Math.PI/10*e.wobble));else if(e.shape.type==="bitmap"){var o=Math.PI/10*e.wobble,c=Math.abs(i-r)*.1,m=Math.abs(s-l)*.1,f=e.shape.bitmap.width*e.scalar,u=e.shape.bitmap.height*e.scalar,b=new DOMMatrix([Math.cos(o)*c,Math.sin(o)*c,-Math.sin(o)*m,Math.cos(o)*m,e.x,e.y]);b.multiplySelf(new DOMMatrix(e.shape.matrix));var w=a.createPattern(e.shape.bitmap,"no-repeat");w.setTransform(b),a.globalAlpha=1-n,a.fillStyle=w,a.fillRect(e.x-f/2,e.y-u/2,f,u),a.globalAlpha=1}else if(e.shape==="circle")a.ellipse?a.ellipse(e.x,e.y,Math.abs(i-r)*e.ovalScalar,Math.abs(s-l)*e.ovalScalar,Math.PI/10*e.wobble,0,2*Math.PI):he(a,e.x,e.y,Math.abs(i-r)*e.ovalScalar,Math.abs(s-l)*e.ovalScalar,Math.PI/10*e.wobble,0,2*Math.PI);else if(e.shape==="star")for(var p=Math.PI/2*3,L=4*e.scalar,k=8*e.scalar,C=e.x,I=e.y,R=5,S=Math.PI/R;R--;)C=e.x+Math.cos(p)*k,I=e.y+Math.sin(p)*k,a.lineTo(C,I),p+=S,C=e.x+Math.cos(p)*L,I=e.y+Math.sin(p)*L,a.lineTo(C,I),p+=S;else a.moveTo(Math.floor(e.x),Math.floor(e.y)),a.lineTo(Math.floor(e.wobbleX),Math.floor(l)),a.lineTo(Math.floor(i),Math.floor(s)),a.lineTo(Math.floor(r),Math.floor(e.wobbleY));return a.closePath(),a.fill(),e.tick<e.totalTicks}function fe(a,e,n,r,l){var i=e.slice(),s=a.getContext("2d"),o,c,m=E(function(f){function u(){o=c=null,s.clearRect(0,0,r.width,r.height),l(),f()}function b(){y&&!(r.width===h.width&&r.height===h.height)&&(r.width=a.width=h.width,r.height=a.height=h.height),!r.width&&!r.height&&(n(a),r.width=a.width,r.height=a.height),s.clearRect(0,0,r.width,r.height),i=i.filter(function(w){return me(s,w)}),i.length?o=M.frame(b):u()}o=M.frame(b),c=u});return{addFettis:function(f){return i=i.concat(f),m},canvas:a,promise:m,reset:function(){o&&M.cancel(o),c&&c()}}}function W(a,e){var n=!a,r=!!v(e||{},"resize"),l=!1,i=v(e,"disableForReducedMotion",Boolean),s=g&&!!v(e||{},"useWorker"),o=s?ee():null,c=n?ce:de,m=a&&o?!!a.__confetti_initialized:!1,f=typeof matchMedia=="function"&&matchMedia("(prefers-reduced-motion)").matches,u;function b(p,L,k){for(var C=v(p,"particleCount",ne),I=v(p,"angle",Number),R=v(p,"spread",Number),S=v(p,"startVelocity",Number),ye=v(p,"decay",Number),we=v(p,"gravity",Number),xe=v(p,"drift",Number),V=v(p,"colors",ie),Me=v(p,"ticks",Number),Y=v(p,"shapes"),ke=v(p,"scalar"),Ce=!!v(p,"flat"),Z=se(p),K=C,D=[],Pe=a.width*Z.x,Ee=a.height*Z.y;K--;)D.push(ue({x:Pe,y:Ee,angle:I,spread:R,startVelocity:S,color:V[K%V.length],shape:Y[re(0,Y.length)],ticks:Me,decay:ye,gravity:we,drift:xe,scalar:ke,flat:Ce}));return u?u.addFettis(D):(u=fe(a,D,c,L,k),u.promise)}function w(p){var L=i||v(p,"disableForReducedMotion",Boolean),k=v(p,"zIndex",Number);if(L&&f)return E(function(S){S()});n&&u?a=u.canvas:n&&!a&&(a=pe(k),document.body.appendChild(a)),r&&!m&&c(a);var C={width:a.width,height:a.height};o&&!m&&o.init(a),m=!0,o&&(a.__confetti_initialized=!0);function I(){if(o){var S={getBoundingClientRect:function(){if(!n)return a.getBoundingClientRect()}};c(S),o.postMessage({resize:{width:S.width,height:S.height}});return}C.width=C.height=null}function R(){u=null,r&&(l=!1,t.removeEventListener("resize",I)),n&&a&&(document.body.removeChild(a),a=null,m=!1)}return r&&!l&&(l=!0,t.addEventListener("resize",I,!1)),o?o.fire(p,C,R):b(p,C,R)}return w.reset=function(){o&&o.reset(),u&&u.reset()},w}var A;function _(){return A||(A=W(null,{useWorker:!0,resize:!0})),A}function ge(a,e,n,r,l,i,s){var o=new Path2D(a),c=new Path2D;c.addPath(o,new DOMMatrix(e));var m=new Path2D;return m.addPath(c,new DOMMatrix([Math.cos(s)*l,Math.sin(s)*l,-Math.sin(s)*i,Math.cos(s)*i,n,r])),m}function ve(a){if(!P)throw new Error("path confetti are not supported in this browser");var e,n;typeof a=="string"?e=a:(e=a.path,n=a.matrix);var r=new Path2D(e),l=document.createElement("canvas"),i=l.getContext("2d");if(!n){for(var s=1e3,o=s,c=s,m=0,f=0,u,b,w=0;w<s;w+=2)for(var p=0;p<s;p+=2)i.isPointInPath(r,w,p,"nonzero")&&(o=Math.min(o,w),c=Math.min(c,p),m=Math.max(m,w),f=Math.max(f,p));u=m-o,b=f-c;var L=10,k=Math.min(L/u,L/b);n=[k,0,0,k,-Math.round(u/2+o)*k,-Math.round(b/2+c)*k]}return{type:"path",path:e,matrix:n}}function be(a){var e,n=1,r="#000000",l='"Twemoji Mozilla", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji", "EmojiOne Color", "Android Emoji", "system emoji", sans-serif';typeof a=="string"?e=a:(e=a.text,n="scalar"in a?a.scalar:n,l="fontFamily"in a?a.fontFamily:l,r="color"in a?a.color:r);var i=10*n,s=""+i+"px "+l,o=new OffscreenCanvas(i,i),c=o.getContext("2d");c.font=s;var m=c.measureText(e),f=Math.floor(m.width),u=Math.floor(m.fontBoundingBoxAscent+m.fontBoundingBoxDescent);o=new OffscreenCanvas(f,u),c=o.getContext("2d"),c.font=s,c.fillStyle=r,c.fillText(e,0,i);var b=1/n;return{type:"bitmap",bitmap:o.transferToImageBitmap(),matrix:[b,0,0,b,-f*b/2,-u*b/2]}}d.exports=function(){return _().apply(this,arguments)},d.exports.reset=function(){_().reset()},d.exports.create=W,d.exports.shapeFromPath=ve,d.exports.shapeFromText=be})(function(){return typeof window<"u"?window:typeof self<"u"?self:this||{}}(),N,!1);const Ne=N.exports;N.exports.create;class B extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}static get styles(){return`
      :host {
      }
    ...
    `}setOpacity(t){t>=0&&t<=1&&this.style.setProperty("--opacity",t)}incNeck(t){this.style.setProperty("--neck-timing",ze),this.neckSize+=t,this.updateNeck(),this.activity++,this.setOpacity(1),this.playSound()}playSound(){if(!Q)return;if(~~(Math.random()*Oe)===0){const d=~~(Math.random()*F.length),y=F[d];y.currentTime=0,y.play()}}setHead(t){this.style.setProperty("--image-head",`url("images/skins/${t}.png")`)}updateNeck(){this.style.setProperty("--neck-size",`${this.neckSize}px`),$("action")==="confetti"&&Ne({particleCount:50,spread:42,origin:{x:.02,y:1}})}connectedCallback(){this.render(),this.initSound(),this.manageSkins(),setInterval(()=>this.manageEvents(),Ae)}initSound(){if(Q)for(let t=1;t<5;t++)F.push(new Audio(`sounds/chicken-${t}.mp3`))}manageSkins(){J&&this.setHead(J)}manageEvents(){this.activity>0||(Ue&&this.neckSize>0&&this.incNeck(De),$e&&this.setOpacity(Fe)),this.activity=0}render(){this.shadowRoot.innerHTML=`
    <style>${q.styles}</style>
    <div class="container">
      <diplo-head></diplo-head>
      <div class="body"></div>
    </div>`}}customElements.define("diplo-pollo",q);const U=[{value:"original",name:"Genuine DiploPollo™"},{value:"sunglasses",name:"Beach DiploPollo™"},{value:"king",name:"King DiploPollo™"},{value:"niv3k",name:"DiploDuck™"},{value:"halloween",name:"DecapiPollo™"},{value:"nerd",name:"EmPollon™"},{value:"radioactive",name:"ChernoPollo™"},{value:"plucked",name:"CalvoPollo™"},{value:"magician",name:"HarryPollo™"},{value:"pirate",name:"JackSpollow™"},{value:"mustache",name:"GentlePollo™"},{value:"moto",name:"HarleyPollo™"},{value:"pikapollo",name:"PikaPollo™"},{value:"pollocop",name:"PolloCop™"},{value:"santapollo",name:"SantaPollo™"},{value:"pollobros",name:"PolloBros™"},{value:"manzpollo",name:"ManzPollo™"},{value:"ironpollo",name:"IronPollo™"},{value:"batpollo",name:"BatPollo™"},{value:"homerpollo",name:"HomerPollo™"}];class H extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}static get styles(){return`
      :host {
        display: block;
        width: 100%;
        min-height: 50px;
...
`,qe="0.4.1";class j extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}static get styles(){return Be}connectedCallback(){this.render();const[t,...d]=this.shadowRoot.querySelectorAll("input[type=text], select:not([disabled])");this.shadowRoot.querySelector("select-skin").addEventListener("selectskin",({detail:h})=>this.changeHead(h)),t.addEventListener("input",()=>this.updateURL()),d.forEach(h=>h.addEventListener("change",()=>this.updateURL())),this.shadowRoot.querySelector("button").addEventListener("click",()=>this.copyURL())}async copyURL(){const t=this.shadowRoot.querySelector("input[name=channel]");if(!t.value)t.reportValidity();else{localStorage.setItem("channel",t.value);const d=this.shadowRoot.querySelector("textarea").value;await navigator.clipboard.writeText(d)}}changeHead(t){this.style.setProperty("--image-head",`url("images/skins/${t}.png")`),this.updateURL()}getURL(){const t=new URL(location.href),d=`${t.origin}${t.pathname}`,[y,...h]=[...this.shadowRoot.querySelectorAll("input[type=text], select:not([disabled])")],g=y.value,P=this.shadowRoot.querySelector("select-skin"),T=h.filter(M=>M[M.selectedIndex].value!=="none").map(M=>`${M.name}=${M[M.selectedIndex].value}`);T.push(`skin=${P.value}`);const E=T.join("&");return`${d}?channel=${g.toLowerCase()}&${E}`}updateURL(){const t=this.shadowRoot.querySelector("textarea");t.value=this.getURL()}render(){const t=localStorage.getItem("channel")??"";this.shadowRoot.innerHTML=`
    ...
    `}}customElements.define("screen-menu",j);const O=document.querySelector(".container"),{searchParams:He}=new URL(location.href),X=!!He.get("channel");if(X){const x=document.createElement("diplo-pollo");O.classList.add("diplopollo-mode"),x.classList.add("animated"),O.append(x),new Te}if(!X){O.classList.add("menu-mode");const x=document.createElement("screen-menu");O.append(x)}});export default je();
