...
`,v="0.4.2",r=new Audio("sounds/music.mp3");r.loop=!0;const i=document.createElement("div"),f=()=>{r.pause(),i.style.setProperty("--opacity",1)},x=()=>{r.play(),i.style.setProperty("--opacity",0)};i.className="music-icon",i.innerHTML=`
